...
PYBIND11_MODULE(_matrix, m){
    ...
    m.def("bytes", []() { return (size_t)g_counter.g_bytes; });
    m.def("allocated", []() { return (size_t)g_counter.g_allocated; });
    m.def("deallocated", []() { return (size_t)g_counter.g_deallocated; });
